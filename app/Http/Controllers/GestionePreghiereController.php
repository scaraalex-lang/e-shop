...
/**
 * Archivio dei testi di preghiera: è la galleria che si apre nel Ricordino
 * Designer, per non riscrivere la stessa preghiera a ogni ricordino.
 */
class GestionePreghiereController extends Controller
{
    ...
    /** Mostra/nasconde il testo nella galleria del designer. */
