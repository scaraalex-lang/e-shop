...
<div class="flex flex-wrap items-end justify-between gap-4">
    <div>
        ...
        <p class="mt-3 font-sans font-light text-testo-soft leading-relaxed max-w-2xl">
            È la galleria che si apre nel Designer Smart: da telefono la preghiera si sceglie,
            non si scrive. Tieni i testi corti — su un ricordino ci stanno poche righe.
        </p>
    </div>
...
@if ($preghiere->isEmpty())
    <p class="mt-10 font-sans font-light text-testo-soft">
        Archivio vuoto. Finché resta così, il Designer Smart mostra la preghiera della scheda.
    </p>
@else
