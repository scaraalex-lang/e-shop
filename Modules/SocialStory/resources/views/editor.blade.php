...
function renderLibreria(categoria, btn) {
  ...
  grid.innerHTML = items.map(function(a){
    return '<div class="libreria-item" onclick="addAssetLibreria(' + JSON.stringify(a.url) + ',' + JSON.stringify(a.tipo) + ')" title="' + (a.nome||'').replace(/"/g,'&quot;') + '"><img src="' + CDN_MEMORAI + a.url + '" loading="lazy"></div>';
  }).join('');
}
